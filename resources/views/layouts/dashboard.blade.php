...
<style>
    ...
    /* Ajuste au contenu pour ne pas être sous la navbar */
    main { padding-top: 70px; }

    /* Sidebar qui déborde (scroll) si nécessaire */
.sidebar { position: fixed; top: 70px; left: 0; bottom: 0; z-index: 1040; overflow-y: auto; }

    /* Footer fixe en bas */
    footer { position: fixed; left: 0; right: 0; bottom: 0; z-index: 1020; background: rgba(5, 11, 18, 0.96); backdrop-filter: blur(10px); }

    /* Espace pour ne pas cacher le contenu sous le footer */
    .dashboard-content { padding-bottom: 80px; }

    /* Footer dans la sidebar (fixe au bas de la barre) */
    .sidebar-footer{
        position: fixed;
        left: 0;
        width: 16.6667%;
        ...
        border-right: 1px solid rgba(20, 38, 52, 1);
    }
</style>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4 dashboard-content">
            ...
            <footer class="mt-4 mb-2" style="border-top: 1px solid rgba(20, 38, 52, 1);">
                <div class="py-3 text-center text-muted">
                    © {{ date('Y') }} {{ config('app.name') }} — Tous droits réservés.
                </div>
            </footer>

            <footer class="sidebar-footer py-3 px-3 text-center text-muted">
