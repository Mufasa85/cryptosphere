...
<div class="card mb-4">
    <div class="card-body">
        <form method="GET" class="row g-3">
            <div class="col-md-4">
                <input type="date" name="date" class="form-control" value="{{ old('date', $date->format('Y-m-d')) }}">
            </div>
            <div class="col-md-2">
                ...
                <tbody>
                    @forelse($details as $repayment)
                        <tr>
                            ...
                            <td>{{ $repayment->created_at?->format('H:i') }}</td>
                        </tr>
                    @empty
                        <tr><td colspan="5" class="text-center">Aucun remboursement ce jour.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
