...
<div class="at-root">
    ...
    <div class="at-page-header">
        <div>
            <h1 class="at-page-title">Rapport quotidien</h1>
            <p class="at-page-subtitle">Activité du {{ $date->format('d/m/Y') }}</p>
        </div>
    </div>
    ...
    <div class="at-filter-card" style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;">
        <form method="GET" style="display:flex;align-items:center;gap:10px;flex-wrap:wrap;width:100%;">
            <div class="at-search-wrap" style="max-width:220px;">
                ...
                <input type="date" name="date" class="at-search" style="padding-left:38px;" value="{{ old('date', $date->format('Y-m-d')) }}">
            </div>
                ...
                <tbody>
                    @forelse($details as $repayment)
                        ...
                        <tr>
                            ...
                            <td style="color:var(--muted);">{{ $repayment->created_at?->format('H:i') ?? '—' }}</td>
                        </tr>
                    @empty
                        <tr><td colspan="5">
                            <div class="at-empty">
                                ...
                                <p>Aucun remboursement ce jour.</p>
                            </div>
                        </td></tr>
                    @endforelse
                </tbody>
